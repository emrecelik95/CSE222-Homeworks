...
public class LibManageData implements LibData{
    ...
    public User getUser(String name, String password, String authority) {
        ...
        DynamicArray<String> userList = file.readFileIntoArray(getUsersFilename());
    ...
    public Book getBook(int id) {
        LibFileSystem file = new LibFileSystem();
        DynamicArray<String> bookList = file.readFileIntoArray(getBooksFilename());
    ...
    public int generateID(String filename){
        ...
        DynamicArray<String> list = file.readFileIntoArray(filename);
        if(list.size() == 1)
            return 1;
    ...
    public boolean checkBorrowing(String bookId){
        LibFileSystem file = new LibFileSystem(); 
        DynamicArray<String> list = file.readFileIntoArray(getUsersFilename());
    ...
    public void updateBook(Book book) {
        LibFileSystem file = new LibFileSystem(); 
        DynamicArray<String> list = file.readFileIntoArray(getBooksFilename());
