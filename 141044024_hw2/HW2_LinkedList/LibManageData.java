...
public class LibManageData implements LibData{
    ...
    public User getUser(String name, String password, String authority) {
        ...
        LinkedList<String> userList = file.readFileIntoArray(getUsersFilename());
    ...
    public Book getBook(int id) {
        LibFileSystem file = new LibFileSystem();
        LinkedList<String> bookList = file.readFileIntoArray(getBooksFilename());
    ...
    public int generateID(String filename){
        ...
        LinkedList<String> list = file.readFileIntoArray(filename);
        if(list.size() == 1)
            return 1;
    ...
    public boolean checkBorrowing(String bookId){
        LibFileSystem file = new LibFileSystem(); 
        LinkedList<String> list = file.readFileIntoArray(getUsersFilename());
    ...
    public void updateBook(Book book) {
        LibFileSystem file = new LibFileSystem(); 
        LinkedList<String> list = file.readFileIntoArray(getBooksFilename());
