...
public class LibFileSystem {
     ...
     * olacak şekilde LinkedList'e aktarıp bu LinkedList'i return eder.
     * @param filename okunacak dosya
     * @return arr dondurulecek arraylist
     */
    public LinkedList<String> readFileIntoArray(String filename){
    ...
    /**
     * Verilen LinkedList i verilen dosyaya dosyaya yazar.
     ...
     */
    public void writeArrayIntoFile(String filename,LinkedList<String> arr,boolean append){
