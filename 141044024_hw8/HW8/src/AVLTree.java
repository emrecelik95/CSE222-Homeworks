...
public class AVLTree < E
  ...
  private static class AVLNode < E > extends Node < E >  implements TreePrinter.PrintableNode{
    ...
    public TreePrinter.PrintableNode getLeft() {
      return (TreePrinter.PrintableNode) left;
    }

    @Override
    public TreePrinter.PrintableNode getRight() {
      return (TreePrinter.PrintableNode) right;
    }
  ...
  private AVLNode < E > rebalanceLeft(AVLNode < E > localRoot) {
    ...
    if (leftChild.balance > AVLNode.BALANCED) {
      ...
      if (leftRightChild.balance < AVLNode.BALANCED) {
        ...
        leftChild.balance = AVLNode.BALANCED; /////////////DUZELTILDI BALANCED OLARAK ///////////////////////////////
        leftRightChild.balance = AVLNode.BALANCED;
        localRoot.balance = AVLNode.BALANCED;
      }
