...
public class FamilyTree<E extends Comparable<E>>  extends BinaryTree<E> {
     ...
     *
     * @param data root'u ilklendirecek deger
     */
     ...
     * @param parentNickName parent nickname'i
     * @return hep true dondurur
     * @throws Exception exception fırlatıyor
     */
     ...
     *
     * @param data aranacak data
     * @return node bakılacak yer
     */
     ...
     *
     * @param node baslanacak nod
     * @param parent parentın datası
     * @param data  aranacak data
     * @param count sayı
     * @return integer
     */
     ...
     *
     * @param localRoot bakılacak root
     * @param target aranacak target
     * @return node
     */
    ...
    /**
     * Tree'yi level order traverse edip elemanların aralarında bosluk olacak sekilde
     * string dondurur.
     * @return string
     */
    public String toString(){
        String out = "";
        LinkedList<BinaryTree.Node<E>> list = traverseLevelOrder(root);
